 ...
 *   alebo ručne:
 *   1. skopírujte súbor do /config/www/pivna-karta.js
 *   2. Nastavenia → Ovládacie panely → ⋮ → Zdroje → Pridať zdroj
 *        URL: /local/pivna-karta.js      Typ: JavaScript modul
 *   3. do nástenky pridajte kartu "Pivná karta" (type: custom:pivna-karta)
 */
  ...
  _hero(o, symbol) {
    ...
    return `
      <div class="hero">
        ...
        <div class="actions">
          ${o.navigate_url ? `<a class="btn primary" href="${esc(o.navigate_url)}" target="_blank" rel="noopener"><ha-icon icon="mdi:navigation-variant"></ha-icon>Navigovať</a>` : ""}
